...
def main():
    ...
    images, poses, render_poses, hwf, i_split, expressions, lights, details = None, None, None, None, None, None, None, None
    ...
    if hasattr(cfg.dataset, "cachedir") and os.path.exists(cfg.dataset.cachedir):
        ...
        # Load dataset
        images, poses, render_poses, hwf, expressions, lights, details = None, None, None, None, None, None, None
        # exp: 50, pose: 6
        if cfg.dataset.type.lower() == "blender":
            images, poses, render_poses, hwf, i_split, expressions, lights, details,  _, bboxs = load_flame_data(
                cfg.dataset.basedir,
    ...
    for i in trange(start_iter, cfg.experiment.train_iters):
        ...
        if USE_CACHED_DATASET:
            ...
            #print('pose_target', pose_target.shape)
            ...
            if not disable_light:
                light_target =lights[img_idx].to(device)
            detail_target = details[img_idx].to(device)
