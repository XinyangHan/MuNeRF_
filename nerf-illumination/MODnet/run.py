...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--modnet", type=str, default='/mnt/d/heyue/nerf-illumination/MODnet/modnet_webcam_portrait_matting.ckpt', help="Path to modnet model."
    )
    parser.add_argument(
        "--inputdata",
        type=str,
        default="/mnt/d/heyue/nerf-illumination/input/",
        help="Path to load input frames",
    )
    parser.add_argument(
        "--jsonfiles",
        type=str,
        default="/mnt/d/heyue/nerf-illumination/jsons/cl/box.json",
