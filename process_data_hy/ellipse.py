...
img_path = "/data/hanxinyang/MuNeRF_latest/dataset/boy4/ori_imgs/0150.png"
landmark_path = "/data/hanxinyang/MuNeRF_latest/dataset/boy4/ori_imgs/landmark/0150.npy"
...
left_long = abs(int(0.88*delta_x_left))
left_short = int(left_long*0.5)
right_long = abs(int(0.88*delta_x_right))
right_short = int(right_long*0.5)
...
# pdb.set_trace()
cv2.ellipse(img, (int(left_center['x'] - 8) , int(left_center['y'] - 2)), (left_long, left_short), angle_left, 0, 360, (255, 255, 255),-1) #画椭圆
cv2.ellipse(img, (int(right_center['x']), int(right_center['y'] - 2)), (right_long, right_short), angle_right, 0, 360, (255, 255, 255),-1) #画椭圆
    
save_path = os.path.join(output_path, "1.png")
...
parser.add_argument(
    "--mask_root",
    type=str, 
    default="/data/hanxinyang/MuNeRF_latest/dataset/boy4/00160/mask/nonmakeup", 
...
parser.add_argument(
    "--ldmk_root",
    type=str, 
    default="/data/hanxinyang/MuNeRF_latest/dataset/boy4/ori_imgs/landmark", 
    help="/data/hanxinyang/MuNeRF_latest/dataset/boy4/ori_imgs/landmark",
)

parser.add_argument(
    "--ori_img_root",
    type=str, 
    default="/data/hanxinyang/MuNeRF_latest/dataset/boy4/ori_imgs", 
    help="/data/hanxinyang/MuNeRF_latest/dataset/boy4/ori_imgs",
)
...
for thing in masks:
    ...
    cv2.ellipse(ori_mask, (int(left_center['x'] - 8) , int(left_center['y'] - 2)), (left_long, left_short), angle_left, 0, 360, (9, 9, 9),-1) #画椭圆
    cv2.ellipse(ori_mask, (int(right_center['x']), int(right_center['y'])), (right_long, right_short), angle_right, 0, 360, (9, 9, 9),-1) #画椭圆
    final_mask = np.vectorize(d.get)(ori_mask)
    
    target_root = os.path.join(args.ori_img_root, "ellipse_mask_larger")
