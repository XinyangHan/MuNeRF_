...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", default="/data/hanxinyang/MuNeRF_latest/process_data_hy/makeup-transfer-public/face-parsing.PyTorch-master/res/cp/", type=str)
