...
parser.add_argument('--name', type=str, default='', help='path to the no_makeup dir')
...
#     for style in styles:
    ...
    os.makedirs(temp_makeup, exist_ok=True)
...
#     for style in styles:
    ...
    os.system(f"cd /data/hanxinyang/MuNeRF_latest/process_data_hy/makeup-transfer-public && \
                proxychains /data/hanxinyang/miniconda3/envs/makeup-transfer/bin/python src/handle_datasetH.py --type landmark --input {name_root} --output {temp_ldmk}")
    # pdb.set_trace()
...
#     for style in styles:
    ...
    temp_ldmk = os.path.join(name_root, "landmark.pk")
    warp_target = os.path.join(name_source, style, "warp_makeup_%s"%style)
    # print(f"cd /data/hanxinyang/MuNeRF_latest/process_data_hy/makeup-transfer-public && \
    #             /data/hanxinyang/miniconda3/envs/makeup-transfer/bin/python src/handle_datasetH.py --type blend1 --input {name_root} --output {temp_warp} --landmark_input {temp_ldmk} --keep_eye_mouth --include_forehead --adjust_color")
    # os.system(f"cd /data/hanxinyang/MuNeRF_latest/process_data_hy/makeup-transfer-public && \
    #             /data/hanxinyang/miniconda3/envs/makeup-transfer/bin/python src/handle_datasetH.py --type blend1 --input {name_root} --output {temp_warp} --landmark_input {temp_ldmk} --keep_eye_mouth --include_forehead --adjust_color")
    os.system(f"cd /data/hanxinyang/MuNeRF_latest/process_data_hy/makeup-transfer-public && \
    ...
    os.system(f"cd /data/hanxinyang/MuNeRF_latest/process_data_hy/makeup-transfer-public && \
                /data/hanxinyang/miniconda3/envs/makeup-transfer/bin/python src/handle_datasetH.py --type blend1 --input {name_root} --output {temp_warp} --landmark_input {temp_ldmk} --keep_eye_mouth")
...
#     # /data/hanxinyang/MuNeRF_latest/dataset/boy4/00005/warp_makeup_00005
#     warp_target = os.path.join(name_source, style, "warp_makeup_%s"%style)
#     os.makedirs(mask_target_makeup, exist_ok=True)
#     os.makedirs(mask_target_raw, exist_ok=True)
#     os.makedirs(warp_target, exist_ok=True)
