...
def facePartsCoordinatesAPI(img, landmarks,
    ...
    #mouth_lower = api.getLandmarkByName(landmarks, "lower_lip_31")[0]

    n_local = int(n_local)
    if n_local == 3:
        parts = [left_eye, right_eye, mouth]
    elif n_local == 4:
        parts = [left_eye, right_eye, mouth, nose]
    elif n_local == 6:
        parts = [left_eye, right_eye, mouth,
        ...
        parts = [left_eye, right_eye, mouth,
            nose, left_cheek, right_cheek,
            left_eyebrow, right_eyebrow, forehead, nose_upper,
    ...
    for i, part in enumerate(parts):
        ...
        center = part
        radiusx = int(img_size * general_ratio / 2)
        radiusy = int(img_size * general_ratio / 2)

        rects.append([
            center[1]-radiusx, center[1]+radiusy,
            center[0]-radiusx, center[0]+radiusy,
        ])
