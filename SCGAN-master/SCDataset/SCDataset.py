...
class SCDataset():
    ...
    def __getitem__(self, index):
        ...
        print('path!!!!!', nonmakeup_path, makeup_path)
        ...
        print("mask!!!!")
        print(os.path.join(self.dir_seg, makeup_name))
        print(makeup_seg_img)
        ...
        #print('makeup_seg[0]', makeup_seg[0])
        ...
        print(not ((mask_B_eye_left > 0).any() and \
        ...
        print("check!!!")
        print(nonmakeup_seg)
        print({'nonmakeup_seg': nonmakeup_seg, 'makeup_seg': makeup_seg, 'nonmakeup_img': nonmakeup_img,
                'makeup_img': makeup_img,
                'mask_A': mask_A, 'mask_B': mask_B,
                'makeup_unchanged': makeup_unchanged,
                'nonmakeup_unchanged': nonmakeup_unchanged,
                'filename': nonmakeup_name
                })
        # print(makeup_seg)
