...
# CUDA_VISIBLE_DEVICES=1 python3 ./main.py --no_makeup "${mainpath}"/frames --makeuped "${mainpath}"/makeup/$2.jpg --output "${mainpath}"/related/beautygan/$2/
...
# # beautygan ref3
# #CUDA_VISIBLE_DEVICES=1 python3 ./main.py --no_makeup "${mainpath}"/frames --makeuped "${mainpath}"/makeup/$3.jpg --output "${mainpath}"/related/beautygan/$3/
...
# CUDA_VISIBLE_DEVICES=1 python3 ./demo.py --source_dir "${mainpath}"/frames --reference_path "${mainpath}"/makeup/$2.jpg --save_path "${mainpath}"/related/psgan/$2/
...
# #CUDA_VISIBLE_DEVICES=1 python3 ./demo.py --source_dir "${mainpath}"/frames --reference_path "${mainpath}"/makeup/$3.jpg --save_path "${mainpath}"/related/psgan/$3/
...
CUDA_VISIBLE_DEVICES=1 python ../../face_mask/test.py --ckpt_path '/data/heyue/face_mask/res/cp' --respth '/data/heyue/face_mask/res/test_res' --dspth '/data/heyue/face_mask/data'
...
# CUDA_VISIBLE_DEVICES=1 python ./get_masks.py
# CUDA_VISIBLE_DEVICES=1 python ./get_masks.py --source_dir ./MT-Dataset/hy/non-makeup --save_dir ./MT-Dataset/parsing
# rm ./test.txt
# python ./writelines.py --id $2.jpg > ./test.txt
# CUDA_VISIBLE_DEVICES=1 python ./sc.py --phase test --dataroot ./MT-Dataset/hy --dirmap ./MT-Dataset/parsing --save_path "${mainpath}"/related/scgan/$2
...
# CUDA_VISIBLE_DEVICES=0 /home/sunyangtian/py3_202/bin/python3 ./main.py --input ./imgs/non/ --style ./imgs/$2.jpg --savedir "${mainpath}"/related/cpm/$2
# # /home/heyue/miniconda3/envs/cpm/bin/CUDA_VISIBLE_DEVICES=1 python3 /data/heyue/104/tools/readvideo.py --frame_dir "${mainpath}"/related/cpm/$2/ --video_dir "${mainpath}"/related/video/ --id cpm_$2 --video
# #/home/heyue/miniconda3/envs/cpm/bin/CUDA_VISIBLE_DEVICES=1 python3 ./main.py --input ./imgs/non/ --style ./imgs/$3.jpg --savedir "${mainpath}"/related/cpm/$3
# #/home/heyue/miniconda3/envs/cpm/bin/CUDA_VISIBLE_DEVICES=1 python3 /data/heyue/104/tools/readvideo.py --frame_dir "${mainpath}"/related/cpm/$3/ --video_dir "${mainpath}"/related/video/ --id cpm_$3 --video
# cd ..
