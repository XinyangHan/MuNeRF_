...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--landmark_file', type=str, default="../datasets/CL/landmark.pk", help='path of the API landmark (to the pickle file)')
        ...
        self.parser.add_argument('--test_size', type=int, default=200, help="size of the test dataset used for test_forward (effective whether test_random is set or not)")
        self.parser.add_argument('--test_interval', type=int, default=2, help="interval of the test forward (in # of epoch)")
        ...
        self.parser.add_argument('--backup_gpu', type=int, default=3, help='backup gpu: e.g. 1 ,use -1 for CPU, useful when one gpu does not have enough memory')
