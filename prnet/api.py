...
class PRN:
    ...
    def __init__(self, is_dlib = False, prefix = '.'):
        ...
        basedir = '/data/hanxinyang/MuNeRF_latest/'
        prefix = basedir
        #---- load detectors
        if is_dlib:
            import dlib
            detector_path = '/data/hanxinyang/MuNeRF_latest/prnet/Data/net-data/mmod_human_face_detector.dat'
        ...
        prn_path = '/data/hanxinyang/MuNeRF_latest/prnet/Data/net-data/256_256_resfcn256_weight'
        ...
        # uv file
        self.uv_kpt_ind = np.loadtxt('/data/hanxinyang/MuNeRF_latest/prnet/Data/uv-data/uv_kpt_ind.txt').astype(np.int32) # 2 x 68 get kpt
        self.face_ind = np.loadtxt('/data/hanxinyang/MuNeRF_latest/prnet/Data/uv-data/face_ind.txt').astype(np.int32) # get valid vertices in the pos map
        self.triangles = np.loadtxt('/data/hanxinyang/MuNeRF_latest/prnet/Data/uv-data/triangles.txt').astype(np.int32) # ntri x 3
